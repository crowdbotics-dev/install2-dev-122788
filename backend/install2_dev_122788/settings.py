"""
Django settings for install2_dev_122788 project.
...
ROOT_URLCONF = 'install2_dev_122788.urls'
...
WSGI_APPLICATION = 'install2_dev_122788.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "install2_dev_122788 API",
    "DESCRIPTION": "API documentation for install2_dev_122788 App",
    "VERSION": "v1",
}
